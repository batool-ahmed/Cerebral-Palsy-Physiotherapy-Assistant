# This is the Pose Estimation module based on mediapipe's pose landmark model
...
class poseDetector():
    ...
    def highlightPosition(self, img, position):
        cx = position[1]
        cy = position[2]
        cv2.circle(img, (cx, cy), 10, (255, 0, 0), cv2.FILLED)
...
def main():
    ...
    while True:
        ...
        if len(lmList) != 0:
            jointId = 14
            joint = lmList[jointId]

            detector.highlightPosition(img, joint)
